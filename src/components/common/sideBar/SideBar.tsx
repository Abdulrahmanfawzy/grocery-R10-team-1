...
const MenuItems = [
  ...
  { icon: User, label: "Personal Info", url: "/profile/info" },
  {
    ...
    url: "/profile/payments-wallet",
  },
  { icon: Clock, label: "Order History", url: "/profile/orders-history" },
  { icon: List, label: "Smart Lists", url: "/profile/smart-list" },
  { icon: MapPin, label: "Addresses", url: "/profile/addresses" },
  { icon: Shield, label: "Security & Login", url: "/profile/security" },
  { icon: Gift, label: "Loyalty & Rewards", url: "/profile/loyalty" },
