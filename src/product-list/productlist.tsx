    ...
    <div>
      ...
      <div className="relative w-full h-\[400px]">
        ...
        <div className="absolute inset-0 flex flex-col justify-center px-40 pt-50 text-white">
          <p className="uppercase tracking-widest text-lg font-bold">
      ...
      <div>
        <div className="flex gap-10 mt-30 px-40">
          <aside className="w-50 space-y-6">
            {/* Categories */}
            <div>
              <h3 className="font-display text-lg mb-3 text-[#000000]">
                Categories
              </h3>
            ...
            <div>
              ...
              <div className="space-y-2">
                {brands.map((brand, i) => (
                  <label
                    key={brand}
                    className="flex items-center gap-2 text-sm font-body text-[#000000] cursor-pointer"
                  >
            ...
            {/* Search */}
            <div>
              <h3 className="font-display text-lg mb-3 text-[#071C1F]">
                <Minus size={20} className="inline mr-2" /> Search Objects
              </h3>
              <div className="flex gap-2">
                ...
                <Button
                  size="icon"
                  className="bg-[#014162] text-primary-foreground shrink-0"
                >
                  <Search size={20} />
                </Button>
              </div>
            ...
            <div>
              <h3 className="font-display text-lg mb-3 text-[#071C1F]">
                <Minus size={20} className="inline mr-2" /> Filter By Price
              </h3>
              <p className="text-sm text[#0E1112] font-body">
                Your range:{" "}
                <span className="text-foreground font-semibold ml-10 ">
